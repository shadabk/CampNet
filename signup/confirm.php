...
if($result){
	$query = "INSERT INTO signupinfo(timestamp, signup_sr, name, college, branch, year, mis, username, emailID, password, ads_count) SELECT timestamp, signup_sr, name, college, branch, year, mis, username, emailID, password, ads_count FROM tempsignupinfo WHERE passkey = '$passkey'";
...
echo 'window.location.href = "../userhome/index.html";';
echo '</script>';
	}
