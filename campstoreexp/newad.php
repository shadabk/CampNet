	...
	//$db = mysqli_connect('localhost', 'root', '', 'test');
		...
		if($row['ads_count'] < 10){
			...
			/*	if(isset($_POST["submit"])) {
				...
				$query = "INSERT INTO temp_ads_list (timestamp, title, author, edition, description, image, price, uploader_id, college, branch, year) VALUES ($timestamp, '$title','$author', '$edition', '$description','$target_file', $price, '$uploader_id', '$college', '$branch', '$year')";
